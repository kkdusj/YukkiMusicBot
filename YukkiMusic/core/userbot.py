#
# Copyright (C) 2021-2022 by D1_G5@Github, < https://github.com/D1_G5 >.
#
# This file is part of < https://github.com/D1_G5/YukkiMusicBot > project,
# and is released under the "GNU v3.0 License Agreement".
# Please see < https://github.com/D1_G5/YukkiMusicBot/blob/master/LICENSE >
#
# All rights reserved.
...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("D1_G5")
            ...
            try:
                await self.one.send_message(
                    config.LOG_GROUP_ID, "◍ تم تشغيل المساعد علي سورس صاصا √"
                )
            except:
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("D1_G5")
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("D1_G5")
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("D1_G5")
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("D1_G5")
